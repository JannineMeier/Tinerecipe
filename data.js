...
(function(){
  ...
  if(!products){
    ...
    const dairy=["Milch","H-Milch","Laktosefreie Milch","Rahm/Sahne","Joghurt natur","Joghurt griechisch","Skyr","Quark","Butter","Margarine","Käse Gouda","Käse Emmentaler","Käse Gruyère","Mozzarella","Feta","Parmesan","Ricotta","Mascarpone","Frischkäse"];
  ...
  function ensureQtyObject(item){
    ...
    if(!unit){ unit = defaultUnitForCategory(item.cat||"Sonstiges"); }
    if(value==null){ value = defaultAmountForUnit(unit); }
  ...
  window.AppData = {
    ...
    norm, UNIT_OPTIONS,
    defaultUnitForCategory, defaultAmountForUnit,
